...
class DeviceModels(object):
    ...
    CAMERA_V4 = [ 'HL_CAM4' ]
    CAMERA_OG = ['WYZECGS']
    CAMERA = CAMERA_V1 + CAMERA_V2 + CAMERA_V3 + CAMERA_OUTDOOR + CAMERA_OUTDOOR_V2 + CAMERA_PAN + CAMERA_BELL + CAMERA_V4 + CAMERA_OG
    ...
    BR30_MESH_BULB = ['HL_BR30C'] + LIGHT_STRIP
    MESH_BULB = ['WLPA19C', 'HL_A19C2'] + BR30_MESH_BULB
