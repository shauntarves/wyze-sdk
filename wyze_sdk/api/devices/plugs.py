...
from wyze_sdk.models.devices.plugs import PlugUsageRecord
...
class PlugsClient(BaseClient):
    ...
    def get_usage_records(self, *, device_mac: str, start_time: datetime, end_time: Optional[datetime] = datetime.now(), **kwargs) -> Sequence[PlugUsageRecord]:
        ...
        if "data" in _records.data and "usage_record_list" in _records.data["data"]:
            return [PlugUsageRecord(**record) for record in _records.data["data"]["usage_record_list"]]
        return []
